    ...
    <>
      ...
      <div className="btn-group">
        ...
        <div className="dropdown-menu">
            <a className="dropdown-item" onClick={() => setTheme("primary")} href="...">
                Primary Theme
            </a>
            <a className="dropdown-item" onClick={() => setTheme("danger")} href="...">
                Danger Theme
            </a>
            <a className="dropdown-item" onClick={() => setTheme("success")} href="...">
                Success Theme
            </a>
            <div className="dropdown-divider"></div>
            <a className="dropdown-item" onClick={() => resetTheme()} href="...">
                Default Theme
            </a>
        </div>
      </div>
